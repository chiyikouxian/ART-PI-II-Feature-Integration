/*
 * operation_mode.c — per-hand operation mode state machine (Left Hand)
 *
...
static short g_dorsal_ax_min = -858,  g_dorsal_ax_max = 1890;
static short g_dorsal_ay_min = -8548, g_dorsal_ay_max = -7158;
static short g_dorsal_az_min = 998,   g_dorsal_az_max = 3496;
...
static finger_window_t g_finger_windows[10] = {
    /* ch0 */ {  4000,  8000, -16500, -14000, -2000,  3000 },
    /* ch1 */ {  2500,  6500, -16500, -13500, -2500,  5500 },
    /* ch2 */ { -7000, -3000, -16000, -10000, -16500, -11000 },
    /* ch3 */ { -2000,  2000, -11000,  0,     -17000, -12000 },
    /* ch4 */ { -5500,    0, -14000, -8000, -16000, -6000 },
    /* ch5 */ { -3500,  2000, -14000, -4000, -19000, -13000 },
    /* ch6 */ { -1500,  4500, -15000, -9000, -16000, -8000 },
    /* ch7 */ { -1500,  4500, -12000, -4000, -19000, -14000 },
    /* ch8 */ {  3500,  9000, -18000, -12000, -19000, -12000 },
    /* ch9 */ {    0,  6000, -14000, -6000, -19000, -13000 },
};
    ...
    while (1) {
        ...
        if (_auto_hit_count >= AUTO_WAKE_CONSECUTIVE_HITS) {
            if (_state == OP_STATE_AUTO_STANDBY) {
                ...
                LOG_I("AUTO: sign completed, sending WAITING_STOP:left");
                imu_wifi_sender_send_model("WAITING_STOP:left\n", 18);
                rt_enter_critical();
...
static void operation_mode_resend_model(void)
{
    ...
    int n = rt_snprintf(p, remain, "MODEL:left,");
    p += n; remain -= n;
    ...
    LOG_I("MODEL:left re-sent (%d bytes)", (int)(p - mbuf));
}
